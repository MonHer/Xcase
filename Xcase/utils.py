...
from Xcase.generalparser import xmind_to_testsuites
...
def get_xmind_testsuites(xmind_file):
    ...
    if xmind_content_dict:
        ...
        logger.error('Invalid XMind file(%s): it is empty!', xmind_file)
        return []
...
def get_xmind_testsuite_list(xmind_file):
    ...
    """
    xmind_file = get_absolute_path(xmind_file)
    logger.info('Start converting XMind file(%s) to testsuite data list...', xmind_file)
    ...
    logger.info('Convert XMind file(%s) to testsuite data list successfully!', xmind_file)
...
def get_xmind_testcase_list(xmind_file):
    ...
    """
    xmind_file = get_absolute_path(xmind_file)
    logger.info('Start converting XMind file(%s) to testcases dict data...' % xmind_file)
...
def xmind_testsuite_to_json_file(xmind_file):
    ...
    xmind_file = get_absolute_path(xmind_file)
    logger.info('Start converting XMind file(%s) to testsuites json file...' % xmind_file)
...
def xmind_testcase_to_json_file(xmind_file):
    ...
    xmind_file = get_absolute_path(xmind_file)
    logger.info('Start converting XMind file(%s) to testcases json file...', xmind_file)
